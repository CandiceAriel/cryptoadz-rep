...
function Home() {
    return (
        <div>
            ...
            <div className='faq d-flex align-items-center justify-content-center'>
                ...
                <div className='img-container  col-md-4 gridImage'>
                    <div className='imgBox'>
                        <img src='/images/401.png' className='about-img' alt='401'/>
                    </div>
                    <div className='imgBox'>
                        <img src='/images/76.png' className='about-img' alt='76'/>
                    </div>
                    <div className='imgBox'>
                        <img src='/images/15232.png' className='about-img' alt='15232'/>
                    </div>
                    <div className='imgBox'>
                        <img src='/images/12221.png' className='about-img' alt='15232'/>
                    </div>
                </div>
            </div>
            <div className='gremplin d-flex align-items-center justify-content-center'>
                <div className='img-container col-md-4'>
                    <div className=''>
                        <img src='/images/temp_gremp.png' className='gremplin-img' alt='gremplin'/>
                    </div>
                </div>
                <div className='text-container col-md-6'>
